import { O as getDefaultEmulatorHostnameAndPort, T as FirebaseError, b as registerVersion, c as _getProvider, d as _registerComponent, h as getApp, k as getModularInstance, w as Component } from "./index.esm2017-DRmNruMr.js";
...
function registerFunctions(fetchImpl, variant) {
	const factory = (container, { instanceIdentifier: regionOrCustomDomain }) => {
		return new FunctionsService(container.getProvider("app").getImmediate(), container.getProvider(AUTH_INTERNAL_NAME), container.getProvider(MESSAGING_INTERNAL_NAME), container.getProvider(APP_CHECK_INTERNAL_NAME), regionOrCustomDomain, fetchImpl);
	};
